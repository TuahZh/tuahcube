...
#        #ns = 0.
    ...
    im = ax.imshow(co_per1, origin="lower",  cmap=cmap, vmin=28.0, interpolation="none") #7sigma
    #draw contour
    cont = ax[radio_header].contour(radio_data, linewidth=0.5,
            levels=arange(0.,1.2,0.1), colors="g", alpha=0.2)
    v = vcut1
...
savefig("co12_channel_maps_%d"%vcut_for_name+"_v1.eps",
        bbox_inches="tight", dpi=70, format="eps")
